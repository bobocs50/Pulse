// SOURCE: github.com/obro79/Rehabify/src/lib/vision/geometry.ts
// Pure geometry utils — steal directly, no changes needed for CPR
// angleBetween() is what we use for elbow lock check (shoulder→elbow→wrist)
